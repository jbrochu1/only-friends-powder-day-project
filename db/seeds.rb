...
t1 = Trip.create(mountain_id: m1.id, user_id: u1.id, trip_start: 'December 16, 2022 11:30', trip_end: 'December 17, 2022 11:30')
t2 = Trip.create(mountain_id: m2.id, user_id: u2.id, trip_start: 'December 16, 2022 11:30', trip_end: 'December 17, 2022 11:30')
